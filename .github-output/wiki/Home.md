...
| rfdiffusion_broad_success | claim | motivation | 0.72 |
...
| unconditional_generates_diverse_structures | claim | s3_unconditional | 0.94 |
| af2_validates_unconditional_designs | claim | s3_unconditional | 0.99 |
| experimental_validation_monomers | claim | s3_unconditional | 1.00 |
| outperforms_hallucination | claim | s3_unconditional | 1.00 |
| fold_conditioned_generation | claim | s3_unconditional | 0.98 |
| alt_af2_coincidence | claim | s3_unconditional | 0.23 |
| alt_nonspecific_folding | claim | s3_unconditional | 0.24 |
...
| ha20_cryoem_structure | claim | s7_binder_design | 0.95 |
| ha20_matches_design | claim | s7_binder_design | 0.91 |
| ha20_atomic_accuracy | claim | s7_binder_design | 0.83 |
| alt_copying_pdb_interfaces | claim | s7_binder_design | 0.15 |
| alt_nonspecific_adhesion | claim | s7_binder_design | 0.18 |
| alt_ha20_alternative_conformation | claim | s7_binder_design | 0.09 |
| comprehensive_improvement | claim | s8_discussion | 0.99 |
| ideality_and_stability | claim | s8_discussion | 0.90 |
| generality_claim | claim | s8_discussion | 0.58 |
...
| alt_ideality_exp_artifact | claim | s8_discussion | 0.32 |
| alt_ideality_fold_artifact | claim | s8_discussion | 0.34 |
