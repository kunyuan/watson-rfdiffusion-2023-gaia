...
REVIEW = ReviewBundle(
    ...
    objects=[
        ...
        review_strategy(_strat_pipeline, conditional_probability=0.92,
            judgment="formalized",
        ...
        review_strategy(_strat_enzyme, conditional_probability=0.75,
            judgment="tentative",
            justification="In silico only, required fine-tuning. No experimental validation."),
