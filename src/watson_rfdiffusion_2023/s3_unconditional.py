...
# AF2 validation supports claim that designs are realistic
_strat_af2_validates = noisy_and(
    ...
    reason=(
        ...
        "were validated by running AF2 and ESMFold structure prediction from the designed "
        "sequences alone. Close agreement between the independently predicted structures and "
        "the design models (up to 600 residues) indicates the designs encode well-defined, "
...
# Compute efficiency follows from pipeline
